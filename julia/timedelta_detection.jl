...
begin
	df = CSV.read("../data/prototype/60.txt", header=["time","temp","heat"], DataFrame)
	dfa = @chain df begin
		@subset((!isnan).(:temp))
		@subset((!isnan).(:heat))
		end
...
@bind sample_rate Slider(1:1:100,show_value=true) # Control sample rate
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "74e8a9ae5fae1b1692e74e0f84ee984de513bc1d"
